  ...
  void _confirmDeleteAccount() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This action is permanent and cannot be undone. All your profile data, skills, and match history will be wiped.',
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      leading: const Icon(Icons.block_flipped, color: Colors.redAccent, size: 20),
                      title: const Text('Blocked Users', style: TextStyle(color: Colors.white, fontSize: 14)),
                    ...
                    ListTile(
                      contentPadding: EdgeInsets.zero,
                      leading: const Icon(Icons.shield_outlined, color: Color(0xFF7C3AED), size: 20),
                      title: const Text('Two-Factor Authentication', style: TextStyle(color: Colors.white, fontSize: 14)),
                      trailing: const Icon(Icons.chevron_right, color: Colors.white30, size: 18),
                      onTap: () => context.push('/profile/2fa', extra: _user),
                    ),
                    const Divider(color: Colors.white10),
                    ListTile(
                      contentPadding: EdgeInsets.zero,
                      leading: const Icon(Icons.download_for_offline_outlined, color: Color(0xFF10B981), size: 20),
                      title: const Text('Export My Data', style: TextStyle(color: Colors.white, fontSize: 14)),
                      subtitle: const Text('Download a JSON copy of your profile', style: TextStyle(color: Colors.white30, fontSize: 10)),
                      trailing: const Icon(Icons.chevron_right, color: Colors.white30, size: 18),
