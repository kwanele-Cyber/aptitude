...
class MatchesScreen extends StatelessWidget {
  ...
  const MatchesScreen({super.key, required this.userData});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => MatchesViewModel()..loadMatches(),
      child: _MatchesScreenContent(userData: userData),
    );
  }
}
...
class _MatchesScreenContent extends StatefulWidget {
  final model.User userData;
  const _MatchesScreenContent({required this.userData});
  @override
...
class _MatchesScreenContentState extends State<_MatchesScreenContent> {
  ...
  @override
  Widget build(BuildContext context) {
    final viewModel = context.watch<MatchesViewModel>();
  ...
  Widget _buildHeader(MatchesViewModel viewModel) {
    return Padding(
  ...
  Widget _buildFilterChips(MatchesViewModel viewModel) {
  ...
  void _showFilterSheet(MatchesViewModel viewModel) {
  ...
  Widget _buildSearchBar(MatchesViewModel viewModel) {
    return SearchAnchor(
  ...
  void _showSaveDialog(MatchesViewModel viewModel) {
  ...
  void _showSavedSearches(MatchesViewModel viewModel) async {
    final auth = AuthService();
